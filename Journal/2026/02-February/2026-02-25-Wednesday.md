...
<< [[Timestamps/2026/02-February/2026-02-24-Tuesday|Yesterday]] | [[Timestamps/2026/02-February/2026-02-26-Thursday|Tomorrow]] >>

---
# [[🌅Morning pages]]
_(escribir sin filtro, sin corregir, sin releer)_

Vuelvo a las páginas después de 2 semanas completas. Hoy miércoles toca ir a la coope. Siento que estoy avanzando en mi dolor de  la 
...
### Notes created today
```dataview
List FROM "" WHERE file.cday = date("2026-02-25") SORT file.ctime asc
```

### Notes last touched today
```dataview
List FROM "" WHERE file.mday = date("2026-02-25") SORT file.mtime asc
```